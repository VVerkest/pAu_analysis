...
int main ( int argc, const char** argv ) {
  ...
  int RunID, EventID, nTowers, nPrimary, nGlobal, nVertices, refMult, gRefMult, nHitsPoss, nHitsFit, nJets;
  double Vx, Vy, Vz, DCA, BbcCoincidenceRate, BbcEastRate, BbcWestRate, vpdVz;
  vector<int> towID, Charge, nCons, leadNcons, subNcons;
  vector<double> towEt, towEta, towPhi, trEta, trPhi, trPz, trPt, jetPt, jetEta, jetPhi, jetEt, leadPt, leadEta, leadPhi, leadEt, subPt, subEta, subPhi, subEt;
  ...
  HTjetTree->Branch("trPx", &trPx);                        HTjetTree->Branch("trPy", &trPy);                        HTjetTree->Branch("trPz", &trPz);
