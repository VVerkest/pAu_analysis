...
int main ( int argc, const char** argv ) {
    ...
    string outFile          { (argc>4) ? argv[4]       : "trig_Check"                                         };
    ...
    while ( Reader.NextEvent() ) {
        ...
        // check the triggers:
        /* unsigned int ntriggers = header->GetNOfTriggerIds(); */
        /* const TArrayI*     array     = header->GetTriggerIdArray(); */
        /* for (unsigned int i=0; i<ntriggers; ++i) { */
        /*     int id = array->At(i); */
        /*     if (which_trigs.count(id) ==0) { */
        /*         which_trigs.insert(id); */
        /*         cout << "trigger " << i << " " << array->At(i) << endl; */
        /*     } */
        /* } */
        /* continue; */
    ...
    cout << " sorted: " << endl;
    for (auto i : which_trigs) cout << i << endl;
