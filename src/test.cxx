...
int main(){
  ...
  inFile = "production_pAu200_2015/MB/pAu_2015_200_MB*.root";    outFile = "out/pAuJets_test.root";    nEvents = 10000000;
  ...
  while ( Reader.NextEvent() ) {
    ...
    //NEF = (double) Eneu/Echg;
    //cout<<Echg<<"  charged\t"<<Eneu<<" neutral\t  NEF = "<<NEF<<endl;
