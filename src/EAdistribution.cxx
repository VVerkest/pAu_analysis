...
int main ( int argc, const char** argv ) {         // funcions and cuts specified in pAuFunctions.hh
  ...
  else if ( argc==1 ) { inFile="production_pAu200_2015/MB/pAu_2015_200_MB*.root"; outFile="src/EAdistribution.root"; number_of_events=100000; }
  else { cerr<< "incorrect number of command line arguments"; return -1; }

  TH1::SetDefaultSumw2();  TH2::SetDefaultSumw2();  TH3::SetDefaultSumw2();

  TH1D *hEAdist = new TH1D( "hEAdist", "BBC Inner East Sum;BBCEsum", 280000,0,70000 );
