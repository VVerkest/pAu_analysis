...
void rho_debug(){
  ...
  TString fileName = "out/UE/pAuHTjetUE_hadcorr_sys.root";
  ...
  c0->SaveAs( "plots/UE/inLead/leadPtVsPtCorrected_towersys1.pdf" , "PDF" );
  
  hBGchg->Scale(1./hBGchg->Integral("WIDTH"));
  hBGchg->Draw("COLZ");
  c0->SaveAs( "plots/UE/inLead/chgBgEtaPhi_towersys1.pdf" , "PDF" );
  
  hBGneu->Scale(1./hBGneu->Integral("WIDTH"));
  hBGneu->Draw("COLZ");
  c0->SaveAs( "plots/UE/inLead/neuBgEtaPhi_towersys1.pdf" , "PDF" );

  hTowersVsRho->Scale(1./hTowersVsRho->Integral("WIDTH"));
  hTowersVsRho->GetZaxis()->SetRangeUser(0.0000001,1);
  hTowersVsRho->Draw("COLZ");
  c0->SaveAs( "plots/UE/inLead/towersVsRho_towersys1.pdf" , "PDF" );

  c0->SetLogy();

  hRho->Scale(1./hRho->Integral("WIDTH"));
  hRho->Draw();
  c0->SaveAs( "plots/UE/inLead/rho_towersys1.pdf" , "PDF" );
  ...
  leg0->Draw();
  c1->SaveAs( "plots/UE/inLead/BBCEastSum_by_eta_towersys1.pdf" , "PDF" );
  c1->SetLogy(0);
  ...
  leg0a->Draw();
  c1->SaveAs( "plots/UE/inLead/BBCEastSum_by_pt_towersys1.pdf" , "PDF" );
  c1->SetLogy(0);
  ...
  leg0b->Draw();
  c1->SaveAs( "plots/UE/inLead/BBCEastSum_by_ptCorrected_towersys1.pdf" , "PDF" );
  c1->SetLogy(0);
  ...
  leg1->Draw();
  c1->SaveAs( "plots/UE/inLead/LeadEta_by_pt_towersys1.pdf" , "PDF" );
  ...
  leg2->Draw();
  c1->SaveAs("plots/UE/inLead/rhoByLeadPt_towersys1.pdf","PDF");
  ...
  leg3->Draw();
  c1->SaveAs("plots/UE/inLead/rhoByLeadPt_LOEA_towersys1.pdf","PDF");
  ...
  leg4->Draw();
  c1->SaveAs("plots/UE/inLead/rhoByLeadPt_HIEA_towersys1.pdf","PDF");
  ...
  leg12->Draw();
  c1->SaveAs("plots/UE/inLead/rhoByLeadPt_correctedPt_towersys1.pdf","PDF");
  ...
  leg13->Draw();
  c1a->SaveAs("plots/UE/inLead/rhoByLeadPt_LOEA_correctedPt_lin_towersys1.pdf","PDF");
  ...
  leg14->Draw();
  c1a->SaveAs("plots/UE/inLead/rhoByLeadPt_HIEA_correctedPt_lin_towersys1.pdf","PDF");
  ...
  for ( int p=0; p<nPtBins; ++p ) {
    ...
    leg5[p]->Draw();
    saveName = "plots/UE/inLead/BBCEastSum_by_eta" + ptBinName[p] +"_towersys1.pdf";
  ...
  for ( int p=0; p<nPtBins; ++p ) {
    ...
    leg6[p]->Draw();
    saveName = "plots/UE/inLead/BBCEastSum_by_eta" + ptBinName[p] +"_corrected_towersys1.pdf";
    c2->SaveAs( saveName , "PDF" );
  }
  ...
  c3->SaveAs("plots/UE/inLead/CorrectedPtRatioPlot_towersys1.pdf","PDF");
