...
void HTJP2Plot() {
  ...
  TH2D *sLeadEta = new TH2D( "sLeadEta", "Lead Jet #eta by p_{T};#eta;", 40,-1.0,1.0, 10,0.2, 1.4 );
  sLeadEta->SetStats(0);
  ...
  TH2D *sSubEta = new TH2D( "sSubEta", "Sub Jet #eta by p_{T};#eta;", 40,-1.0,1.0, 10,0.2, 1.4 );
  sSubEta->SetStats(0);
