...
void dijetPlots() {
  ...
  for ( int i=0; i<nPtBins; ++i ) {
    ...
    name = "plots/UEvsBBCE" + ptBinName[i] + "_CHG.pdf";
    c0->SaveAs( name,"PDF");
    ...
    name = "plots/UEvsBBCsumE" + ptBinName[i] + "_CHG.pdf";
    c1->SaveAs( name,"PDF");
  ...
  c1->SaveAs( "plots/UE_BBCE_profile_CHG.pdf","PDF");          c1->Clear();
  ...
  c1->SaveAs( "plots/UE_BBCsumE_profile_CHG.pdf","PDF");          c1->Clear();
  ...
  c5->SaveAs( "plots/UE_BBCE_profileY_CHG.pdf","PDF");          c5->Clear();
  ...
  c6->SaveAs( "plots/UE_BBCsumE_profileY_CHG.pdf","PDF");        c6->Clear();
  ...
  c5->SaveAs( "plots/UE_BBCE_projectionY_CHG.pdf","PDF");
  ...
  c6->SaveAs( "plots/UE_BBCsumE_projectionY_CHG.pdf","PDF");
  ...
  leg2->Draw();  c3->Modified();  c3->cd();  c3->SetSelected(c3);  c3->SaveAs("plots/RhoByLeadPt_CHG.pdf","PDF");
  ...
  c4->SaveAs("plots/LeadEtaPhi_CHG.pdf","PDF");

  hSubEtaPhi->Scale( 1./hSubEtaPhi->Integral("width") );
  hSubEtaPhi->Draw("COLZ");
  c4->SaveAs("plots/SubEtaPhi_CHG.pdf","PDF");
  ...
  c4->SaveAs("plots/TowersVsRho_CHG.pdf","PDF");
  c4->Clear();
  
  hPrimaryVsGlobal->Scale( 1./hPrimaryVsGlobal->Integral("width") );
  hPrimaryVsGlobal->Draw("COLZ");
  c4->SaveAs("plots/PrimaryVsGlobal_CHG.pdf","PDF");
  ...
  c4->SaveAs("plots/PrimaryVsBBCsumE_CHG.pdf","PDF");
  ...
  c4->SaveAs("plots/hTowersVsBBCsumE_CHG.pdf","PDF");
