...
echo sbatch --mem-per-cpu=8GB -q express -p erhip -o $LogFile -e $ErrFile -t 45 --job-name=pAu_analysis -- ${ExecPath}/submit/qwrap.sh ${ExecPath} $execute $arg

sbatch --mem-per-cpu=8GB -q express -p erhip -o $LogFile -e $ErrFile -t 45 --job-name=pAu_analysis -- ${ExecPath}/submit/qwrap.sh ${ExecPath} $execute $arg
