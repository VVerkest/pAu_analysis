root -l <<EOF
    ...
    const char* in_file = "hadd_sparse_wsu_HT.root";

    tuGetter got{};
    auto hg = (TH2D*) got(in_file,"h2UE");
    ...
    auto px = (TProfile*) got(in_file,"EA_tpc_vs_bbc");
    auto py = (TProfile*) got(in_file,"EA_bbc_vs_tpc");
    ...
    auto cnt = (TH2D*) got(in_file,"hg_bbc3070");
