root -l <<EOF
    ...
    tu_fmt(T_R, {{"Title", "Ratio: Truth (A:B)",     "MarkerStyle", kFullCircle,       "MarkerSize", 1.4, "MarkerAlpha", 0.6, "MarkerColor", kRed, "yAxisRangeLo", 0., "yAxisRangeHi", 0.6}});
