...
namespace Analysis {
  ...
  void AddCorrected2DHistograms( TH2D *[nEffEtaBins], TH2D *[nEtaBins] );
  ...
  void GenerateWeightedPtResponse( TH1D *[nPtBins], TH1D *[21], TH1D *, TString );
  ...
  void ProjectAndSaveFinalUEPlots( TH1D *, TString, int, TString );
  
  void ProjectAndScaleUEHistogramForAllPt( TH2D *, TH1D *, TH1D *[55], int, TString );
  
  void ProjectPartLevelJetPt( TH2D*, TH1D*[21], TString );

  TH2D *ProjectUEHistograms( TH3D *, int, TString );

  void TrackingEfficiency2DCorrection( TH2D*, TH2D*, TFile *, TString );

  bool UseTriggerTower( int );

  void WeightUEPtByLeadPtAndFakes( TH1D *[nPtBins], TH1D *[55], TH1D *[nPtBins], TH1D *, TH1D *, int, TString );
